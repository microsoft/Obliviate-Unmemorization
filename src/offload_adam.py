...
__all__ = ["StateOffloadAdamW", "adamw"]


class StateOffloadAdamW(Optimizer):
    def __init__(
        self,
        params: ParamsT,
    ...
    def step(self, closure=None):
        ...
        """
        self._move_opt_states_to(torch.device('cuda'))
        ...
        self._move_opt_states_to(torch.device('cpu'))

        return loss

    def _move_opt_states_to(self, device):
